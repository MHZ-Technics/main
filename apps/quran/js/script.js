...
function GetSurahName() {
    ...
    for (i = SurahSelected.length-1; i >=0 ; i--) {
        if (SurahSelected[i].checked) {
            ...
            SurahNameF = SurahNameWIndex.SurahName[SelectSurahCnt];
        }
    }
}
...
function GetSheikhName() {
    ...
    for (i = 0; i < SheikhSelected.length; i++) {
        if (SheikhSelected[i].checked) {
            ...
            SheikhName = SheikhNameWIndex.SheikhName[SelectNameCnt];
...
function UpdateProgressBar(e) {
    if (IsPlaying == true) {
        ...
        localStorage.setItem("UpdateProgressBar",Progress.style.width);
        localStorage.setItem("DurationTimeEl",DurationTimeEl.innerHTML);
        localStorage.setItem("CurrentTimeEl",CurrentTimeEl.innerHTML);
...
function loadQuran(SurahNameF) {
    ...
    localStorage.setItem("SurahName" , SurahNameF);
    localStorage.setItem("stgindex", StgIndex);
    localStorage.setItem("sheikhname",SheikhName);
    localStorage.setItem("sheikhindex",SheikhIndex);
...
if(WallNum==0){
    SurahNameF = localStorage.getItem("SurahName");
    StgIndex= localStorage.getItem("stgindex");
    SheikhName =localStorage.getItem("sheikhname");
    SheikhIndex= localStorage.getItem("sheikhindex");
    audioElement.currentTime=localStorage.getItem("CurrentTimeWidth");
    Progress.style.width = localStorage.getItem("UpdateProgressBar");
    DurationTimeEl.innerHTML= localStorage.getItem("DurationTimeEl");
    CurrentTimeEl.innerHTML= localStorage.getItem("CurrentTimeEl");
    if(SurahNameF){
loadQuran(SurahNameF);
    }
}
...
localStorage.setItem("CurrentTimeWidth",audioElement.currentTime);
}
if(WallNum==0){
    SurahNameF = localStorage.getItem("SurahName");
    StgIndex= localStorage.getItem("stgindex");
...
function ClearProgress(){
    localStorage.setItem("UpdateProgressBar",0);
    localStorage.setItem("DurationTimeEl","00:00");
    localStorage.setItem("CurrentTimeEl","00:00");
    Progress.style.width=0;
